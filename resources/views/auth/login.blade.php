        ...
        <div class="relative z-10 flex flex-col justify-end p-20 w-full">
            <div class="space-y-6 max-w-xl">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-indigo-400 font-bold uppercase tracking-[0.3em] text-[10px]">Welcome Back</span>
                </div>
                <h1 class="text-6xl font-outfit font-black text-white leading-none tracking-tighter">
                    Manage your <br><span class="text-indigo-500 underline decoration-indigo-500/30 underline-offset-8">Studio with ease.</span>
                </h1>
                <p class="text-lg text-slate-300 font-medium leading-relaxed">
                    PixelStudio helps you manage your clients, photos, and payments all in one place. Focus on your photography while we handle the business.
                </p>
            </div>
            ...
            <div class="mt-20 flex items-center gap-6 text-slate-400">
                ...
                <div class="flex flex-col gap-0.5">
                    <span class="text-sm font-black text-white tracking-wide">Trusted by Top Studios</span>
                    <span class="text-[10px] font-medium text-slate-500 uppercase tracking-[0.2em]">Kelechi Amadi-Obi • George Okoro</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="w-full lg:w-2/5 flex items-center justify-center p-8 md:p-16 lg:p-24 bg-white relative">
        <div class="w-full max-sm:max-w-xs lg:max-w-sm">
            <div class="mb-12">
                ...
                <h2 class="text-3xl font-outfit font-black text-slate-900 tracking-tight">Sign <span class="text-indigo-600">In</span></h2>
                <p class="text-slate-500 mt-2 font-medium">Enter your details to access your account</p>
            </div>
            ...
            <form method="POST" action="/login" class="space-y-6">
                ...
                <div class="space-y-1.5 focus-within:translate-x-1 transition-transform">
                    <div class="flex items-center justify-between ml-1">
                        ...
                        <a href="/forgot-password" class="text-[10px] font-black uppercase tracking-widest text-indigo-500 hover:text-slate-900 transition-colors">Forgot?</a>
                    </div>
                    <div class="group relative">
                        <span class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                ...
                <div class="space-y-1.5 focus-within:translate-x-1 transition-transform">
                    <label class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Studio Name <span class="normal-case font-medium lowercase italic text-slate-300 ml-1">(Optional)</span></label>
                    <div class="group relative">
                        <span class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
